...
from deutschland.hilfsmittel import rest
from deutschland.hilfsmittel.configuration import Configuration
from deutschland.hilfsmittel.exceptions import ApiException, ApiTypeError, ApiValueError
from deutschland.hilfsmittel.model_utils import (
    ModelComposed,
    ModelNormal,
    ModelSimple,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance.nachweisschema_id_get  # this is an instance of the class Endpoint
        api_instance.nachweisschema_id_get()  # this invokes api_instance.nachweisschema_id_get.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.nachweisschema_id_get.callable or self.callable in this class
